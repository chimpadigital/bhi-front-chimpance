  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content ">
      <div class="modal-header mt-5 border-0">
        <h3 class="modal-title text-primary text-center m-auto" id="registerLabel" style="z-index: 1;">Crea tu cuenta</h3>
          ...
          <div class="col-lg-8">
            <form action="" class="login mb-4">
              ...
              <div class="form-control text-center mt-4">
                  <button type="submit" class="align-self-center border-2 btn btn-lg btn-outline-primary btn-reservar rounded-pill text-center" data-bs-toggle="modal" data-bs-target="#register-pending" data-bs-dismiss="modal">Registrarme</button>
              </div>
            </form>
          </div>
          <div class="col-lg-2"></div>
