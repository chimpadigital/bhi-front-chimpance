        ...
        <div class="container">
            <div class="row">
                <div class="align-items-center col-12 d-flex justify-content-between mb-5">
                    ...
                    <a href="" data-bs-toggle="modal" data-bs-target="#pasajero" class="btn btn-lg rounded-pill btn-outline-secondary border-2 text-center btn-reservar align-self-center mt-lg-0 mt-4">Nuevo viaje +</a>
                </div>
                ...
                <div class="col-lg-9 col-xxl-9 border-2 border-left border-primary border-start ps-lg-4 z-index--top">
                    ...
                    <h4 class="title-bg mt-4">Tours confirmados</h4>
                    <div class="row mt-4">
                        <div class="tour-card">
                            <div class="tour-wrapper">
                                ...
                                <div class="tour-content">
                                    ...
                                    <a href="tour-agencias-confirmadas.php" class="btn btn-lg rounded-pill btn-primary text-white text-center btn-reservar align-self-center">Ver info</a>
                                </div>
                            </div>
                        </div>
                        <div class="tour-card">
