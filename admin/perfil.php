            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xxl-3 d-none d-md-block">
                    <ul class="list-unstyled pe-3 border-left">
                        ...
                        <li>
                            <a href="agencias.php" class="tours-pasajeros d-flex flex-row p-3 align-items-center text-decoration-none menu-admin active">
                ...
                <div class="col-lg-9 col-xxl-9 border-2 border-left border-primary border-start ps-lg-4 z-index--top">
                    ...
                    <div class="d-flex align-items-baseline">
                        <h4 class="title-bg">Nombre de la agencia</h4>
                    </div>
                    <div class="d-flex align-items-baseline flex-md-row flex-column mt-5">
                        <h2 class="pe-3">Nombre de la agencia</h2>
                        <p>Información de la agencia</p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center z-index--top">
                    <a href="" class="btn btn-lg rounded-pill btn-primary text-white text-center align-self-center me-3" data-bs-toggle="modal" data-bs-target="#agencia-confirmado" >Aprobar</a>
                    <a href="" class="btn btn-lg rounded-pill btn-primary text-white text-center align-self-center" data-bs-toggle="modal" data-bs-target="#agencia-eliminada">Dar de baja</a>
                </div>
            </div>
        </div>
    </section>
