        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center z-index--top">
                    <a href="" class="btn btn-lg rounded-pill btn-primary text-white text-center align-self-center me-3" data-bs-toggle="modal" data-bs-target="#pasajero-confirmado" >Aprobar</a>
                    <a href="" class="btn btn-lg rounded-pill btn-primary text-white text-center align-self-center" data-bs-toggle="modal" data-bs-target="#pasajero">Dar de baja</a>
                </div>
            </div>
        </div>
    </section>
