        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-xxl-9 border-2 border-left border-primary border-start ps-lg-4 z-index--top">
                    ...
                    <div class="d-flex align-items-baseline flex-lg-row flex-column mt-5">
                        <h2 class="pe-3">Agencia A</h2>
                        <p class="mb-0 ">Información de la agencia</p>
                    </div>
                    <div class="d-flex flex-row flex-lg-row flex-column justify-content-between">
                        <h4 class="title-bg mt-4">Pasajeros confirmados</h4>
                        <a href="" data-bs-toggle="modal" data-bs-target="#pasajero" class="btn btn-lg rounded-pill btn-outline-secondary border-2 text-center btn-reservar align-self-lg-center align-self-baseline mt-lg-0 mt-4">Aprobar todos</a>
                    </div>
                    <div class="mt-4">
                        <div class="pasajero-admin bg-light d-md-flex flex-wrap flex-lg-row align-items-center justify-content-between p-3 mb-3">
                            ...
                            <div>
                                <a href="pasajero-confirmado.php" class="me-2 mt-3 mt-lg-0 btn btn-lg rounded-pill btn-primary text-white text-center btn-reservar align-self-center">Ver planilla</a>
                            </div>
                        </div>
                        <div class="pasajero-admin bg-light d-md-flex flex-wrap flex-lg-row align-items-center justify-content-between p-3 mb-3">
                            <div class="d-flex align-items-center">
