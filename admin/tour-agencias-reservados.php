            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-xxl-9 border-2 border-left border-primary border-start ps-lg-4 z-index--top">
                    ...
                    <div class="d-flex align-items-baseline flex-lg-row flex-column mt-5">
                        <h2 class="pe-lg-3">Agencia A</h2>
                        <p class="mb-0 ">Información de la agencia</p>
                    </div>
                    <div class="d-flex flex-lg-row flex-column justify-content-lg-between mt-4">
                        <h4 class="title-bg">Pasajeros con reservas</h4>
                        <a href="" data-bs-toggle="modal" data-bs-target="#pasajero-confirmado" class="btn btn-lg rounded-pill btn-outline-secondary border-2 text-center btn-reservar align-self-lg-center align-self-baseline mt-lg-0">Aprobar todos</a>
                    </div>
                    <div class="mt-4">
