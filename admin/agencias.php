                        ...
                        <div class="col-12 mt-4">
                            <form action="" class="login">
                                <div class="form-control p-0 position-relative">
                                    <input type="search" class="w-100 border-secondary" placeholder="Buscar nombre de agencia">
                                    <img src="../assets/images/body/icons/search-icon.svg" class="position-absolute search-icon" alt="">
                                </div>
                            </form>
                        </div>
                    </div>
                    <h4 class="title-bg mt-4">Agencias registradas</h4>
                    <div class="row mt-4">
                        <div class="tour-card">
                            <div class="tour-wrapper">
                                <div class="tour-img"><img src="../assets/images/body/tours/5.jpg" class="img-fluid" alt=""></div>
                                <div class="tour-content">
                                    <h5 class="mb-3 mt-3 text-center">Agencia A</h5>
                                   
                                    <a href="perfil.php" class="btn btn-lg rounded-pill btn-primary text-white text-center btn-reservar align-self-center">Ver info</a>
                                </div>
                            </div>
                        </div>
                        <div class="tour-card">
                            <div class="tour-wrapper">
                                ...
                                <div class="tour-content">
                                    <h5 class="mb-3 mt-3 text-center">Agencia B</h5>
                        ...
                        <div class="tour-card">
                            <div class="tour-wrapper">
                                ...
                                <div class="tour-content">
                                    <h5 class="mb-3 mt-3 text-center">Agencia C</h5>
                        ...
                        <div class="tour-card">
                            <div class="tour-wrapper">
                                <div class="tour-img"><img src="../assets/images/body/tours/5.jpg" class="img-fluid" alt=""></div>
                                <div class="tour-content">
                                    <h5 class="mb-3 mt-3 text-center">Agencia D</h5>
                        ...
                        <div class="tour-card">
                            <div class="tour-wrapper">
                                <div class="tour-img"><img src="../assets/images/body/tours/4.jpg" class="img-fluid" alt=""></div>
                                <div class="tour-content">
                                    <h5 class="mb-3 mt-3 text-center">Agencia E</h5>
                        ...
                        <div class="tour-card">
                            <div class="tour-wrapper">
                                <div class="tour-img"><img src="../assets/images/body/tours/03.jpg" class="img-fluid" alt=""></div>
                                <div class="tour-content">
                                    <h5 class="mb-3 mt-3 text-center">Agencia F</h5>
