        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-xxl-9 border-2 border-left border-primary border-start ps-lg-4 z-index--top">
                    ...
                    <h4 class="title-bg mt-4">Datos de la agencia</h4>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center z-index--top">
                    <a href="" data-bs-toggle="modal" data-bs-target="#agencia-confirmado" class="me-2 btn btn-lg rounded-pill btn-primary text-white text-center btn-reservar align-self-center">Aprobar</a>
