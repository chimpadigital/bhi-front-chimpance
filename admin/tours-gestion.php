...
<?php include 'header-admin.php'; ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xxl-3 d-none d-md-block">
                    <ul class="list-unstyled pe-3 border-left">
                        ...
                        <li>
                            <a href="tours-gestion.php" class="tours-pasajeros d-flex flex-row p-3 align-items-center text-decoration-none menu-admin active">
                                <!-- <img src="/assets/images/body/tours-admin.svg" class="pe-3" alt=""> -->
                ...
                <div class="col-lg-9 col-xxl-9 border-2 border-left border-primary border-start ps-lg-4 z-index--top">
                    <ul class="nav nav-tabs">
                        <li class="nav-item pe-2">
                            <a class="nav-link active" aria-current="page" href="tours.php">Tours / Viajes</a>
                        </li>
                    </ul>
                    <div class="row">
                        <div class="col-12 mt-4">
                            <form action="" class="login">
                                <div class="form-control p-0 position-relative">
                                    <input type="search" class="w-100 border-secondary" placeholder="Buscar por destino, nombre o mes">
                    ...
                    <h4 class="title-bg mt-4">Viajes Publicados</h4>
                    <div class="row mt-4">
                        <div class="tour-card">
                            <div class="tour-wrapper">
                                ...
                                <div class="tour-content">
                                    ...
                                    <a href="tours-edit-create.php" class="btn btn-lg rounded-pill btn-primary text-white text-center btn-reservar align-self-center">Modificar viaje</a>
                                    <a href="" data-bs-toggle="modal" data-bs-target="#tour-cancelado" class="mt-4 btn btn-lg rounded-pill btn-primary text-white text-center btn-reservar align-self-center">Cancelar viaje</a>
                                </div>
                            </div>
                        </div>
                        <div class="tour-card">
    ...
    <?php include 'modal-tour-cancelado.php'; ?>
